...
public class CensusAnalyserMainTest {
    ...
    public void givenRecordInCSVFile_WhenNumberOfRecordMatch_ThenTrue() throws Exception {
        CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
        int record=censusAnalyser.loadCensusData(STATE_CENSUS_DATA_CSV_FILE_PATH);
    ...
    public void givenStateCensusCSVFile_WhenIncorrectFileName_ThenCustomException() throws Exception {
        try {
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CENSUS_DATA_CSV_FILE_INCORRECT_PATH);
            int size=censusAnalyser.sizeOfRecords();
    ...
    public void givenCSVFile_WhenIncorrectTypeMatch_ThenTrue() throws Exception {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CENSUS_DATA_CSV_INCORRECT_FILE_TYPE);
        }catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.MyException_Type.FILE_NOT_FOUND,e.type);
        }
    }
    ...
    public void givenCSVFile_WhenIncorrectDelimiter_ThenTrue() throws Exception {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CENSUS_DATA_CSV_INCORRECT_DELIMITER_FILE_TYPE);
        }catch (CensusAnalyserException e) {
    ...
    public void givenCSVFile_WhenIncorrectHeader_ThenTrue() throws Exception {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CENSUS_DATA_CSV_INCORRECT_HEADER_FILE);
        }catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.MyException_Type.DELIMITER_INCORECT,e.type);
        }
    }
    ...
    public void givenCheckWithStateCodeCSV_WhenNumberOfRecordMatches_ThenTrue() throws Exception {
        CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
         int stateCensusDataRecords = censusAnalyser.loadCensusData(STATE_CODE_DATA_CSV_FILE_PATH);
    ...
    public void givenStateCodeCSVFile_WhenIncorrectFileName_ThenCustomException() {
        try {
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CODE_DATA_CSV_FILE_INCORRECT_PATH);
        }catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.MyException_Type.FILE_NOT_FOUND,e.type);
        }
    }
    ...
    public void givenStateCodeCSVFile_WhenIncorrectTypeMatch_ThenTrue() throws Exception {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CODE_DATA_CSV_FILE_INCORRECT_TYPE);
        }catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.MyException_Type.FILE_NOT_FOUND,e.type);
        }
    }
    ...
    public void givenStateCodeeCSVFile_WhenIncorrectDelimiter_ThenTrue() throws Exception {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CODE_DATA_CSV_FILE_INCORRECT_DELIMITER);
        }catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.MyException_Type.DELIMITER_INCORECT,e.type);
        }
    }
    ...
    public void givenStateCodeCSVFile_WhenIncorrectHeader_ThenTrue() throws Exception {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CODE_DATA_CSV_FILE_INCORRECT_HEADER);
        }catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.MyException_Type.DELIMITER_INCORECT,e.type);
        }
    }
    ...
    public void givenStateCensusData_WhenStateWiseSort_ThenReturn() {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData(STATE_CENSUS_DATA_CSV_FILE_PATH);
   ...
   @Test
    public void givenStateCodeData_WhenStateCodeWiseSort_ThenReturn() {
        try{
            CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.INDIA);
            censusAnalyser.loadCensusData (STATE_CODE_DATA_CSV_FILE_PATH);
    ...
    @Test
    public void givenRecordInUSCSVFile_WhenNumberOfRecordMatch_ThenTrue() throws Exception {
        CensusAnalyserMain censusAnalyser = new CensusAnalyserMain(CensusAnalyserMain.COUNTRY.US);
        int record=censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);

...
public class USCensusPOJO {
    ...
    public USCensusPOJO(String state_Id, String state, int population, int housing_Units, float total_Area,
                        float water_Area, float land_Area, float population_Density, float housing_Density) {
